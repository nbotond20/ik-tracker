...
const variantClasses = {
  ...
  danger: 'bg-red-100 text-red-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-red-800 dark:text-red-200',
  success:
    'bg-green-100 text-green-800 text-xs font-medium px-2.5 py-0.5 rounded dark:bg-green-800 dark:text-green-300',
  warning: 'bg-yellow-100 text-yellow-800 text-xs font-medium px-2.5 py-0.5 rounded dark:text-orange-600',
}
