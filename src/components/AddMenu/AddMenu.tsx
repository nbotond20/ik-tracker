                ...
                <div className="flex justify-center items-center space-x-4">
                  {menuItems.map((menuItem, idx) => (
                    <button
                      key={idx}
                      type="button"
                      className="sm:whitespace-nowrap py-2 px-3 text-sm font-medium text-gray-500 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-primary-300 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"
                      onClick={() => {
                        menuItem.onClick()
                        setIsOpen(false)
                      }}
