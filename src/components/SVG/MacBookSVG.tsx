export const MacBookSVG = () => {
  return (
    <>
      {/* <div className="bg-white w-[432px] h-[272px] absolute top-[158px] left-[95px]">
        <Image src="" width={432} height={272} alt="Macbook screen" />
      </div> */}
            ...
            <g id="macbook pro retina">
              <g id="monitor">
                ...
                <path
                  id="monitor"
                  className="s1"
                  d="m673 90c12.7 0 23 10.3 23 23v381h-593v-381c0-12.7 10.3-23 23-23z"
                />
