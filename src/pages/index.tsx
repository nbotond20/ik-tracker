    ...
    <div className="hideScrollbar relative max-h-[calc(100vh-64px)] w-screen snap-none overflow-auto scroll-smooth md:snap-y md:snap-mandatory">
      ...
      >
        <section className="bg-white dark:bg-gray-900">
          <div className="mx-auto flex max-w-screen-xl px-4 py-8 lg:grid-cols-12 lg:gap-8 lg:py-16 xl:gap-0">
      ...
      >
        {/* Features */}
        <div className="max-w-screen-xl space-y-8 px-4 py-8 pb-20 md:grid md:grid-cols-2 md:gap-12 md:space-y-0 lg:grid-cols-3 lg:py-16">
          <div>
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400">
              Auto-assign tasks, send Slack messages, and much more. Now power up with hundreds of new templates to help
              you get started.
            </p>
          </div>
          <div>
